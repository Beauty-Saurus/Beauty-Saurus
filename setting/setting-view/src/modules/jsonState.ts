...
// 액션을 만들어주는 함수
export const initializeState = createAction(INITIALIZE_STATE, (state): WholeJSONType => state)();
export const addFeatureState = createAction(ADDFEATURE_STATE, (state): FeatureType => state)();

// 액션들 여러 개 생기면 객체화해서 편하게 쓸라고 묶어 주는거
export const actions = { initializeState, addFeatureState };
// 액션의 타입 맨드러주는거
